...
class TestStellarBurgerConstructor:
    def test_constructor_sauces(self, driver):
        ...
        sauce = WebDriverWait(driver, 5).until(EC.visibility_of_element_located((By.XPATH, ".//ul[2]/a[1]/p"))).text
    ...
    def test_constructor_fillings(self, driver):
        ...
        filling = WebDriverWait(driver, 5).until(EC.visibility_of_element_located((By.XPATH, ".//ul[3]/a[1]/p"))).text
    ...
    def test_constructor_buns(self, driver):
        ...
        bun = WebDriverWait(driver, 5).until(EC.visibility_of_element_located((By.XPATH, ".//ul[1]/a[1]/p"))).text
